function [u, cost] = DDP_CP(x_curr, u_init, p_target, Q_f, R, Horizon, num_iter, dt, gamma)
...
% V(Horizon) = 0.5 * (abs(x_traj(:,Horizon)) - p_target)' * Q_f * (abs(x_traj(:,Horizon)) - p_target);
